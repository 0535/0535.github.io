...
:netsh interface ip set address name="以太网" source=static addr=10.248.134.12 mask=255.255.255.0 gateway=10.248.134.254
:netsh interface ip set dns name="以太网" addr=10.1.128.10
:IP地址自动获取
